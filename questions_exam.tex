...
% Зелени цветове за поленцата и заглавието
\definecolor{greenprimary}{HTML}{1B5E20}  % Тъмно зелено за заглавието на поленцето
\definecolor{greenaccent}{HTML}{2E7D32}   % Основно зелено за рамката и булетите
\definecolor{greenhighlight}{HTML}{E8F5E9}% Светло зелено за фон на поленцето и акцент на заглавието
...
% Настройка на булетите в зелено
\setlist[itemize,1]{
